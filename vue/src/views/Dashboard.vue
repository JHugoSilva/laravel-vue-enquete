...
<template>
  <PageComponent title="Dashboard">
    ...
    >
      ...
      <div
        class="bg-white shadow-md p-3 text-center flex flex-col order-2 animate-fade-in-down lg:order-4"
      ...
      <div
        class="row-span-2 order-3 animate-fade-in-down bg-white shadow-md p-4 lg:order-1"
        style="animation-delay: 0.1s"
      >
      ...
      <div
        class="row-span-2 order-4 animate-fade-in-down bg-white shadow-md p-3 lg:order-3"
